...
public class PaisController {
	...
	public ResponseEntity<Pais> salvar(@RequestBody Pais pais, @RequestParam String token) {
		try {
	...
	public ResponseEntity<List<Pais>> pesquisar(@RequestParam String token,
	...
	public ResponseEntity<Boolean> excluir(@RequestParam Long id, @RequestParam String token) {
		try {
			Token t = tokenService.getByToken(token);
